    ...
    <div className="px-6 py-6 bg-white min-h-screen transition-all duration-300">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
        ...
        <select
          ...
          className="w-full md:w-[250px] px-4 py-2 border border-gray-300 rounded-full text-gray-700 focus:outline-none focus:ring-2 focus:ring-[rgba(224,99,99,0.85)]"
        >
