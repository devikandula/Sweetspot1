...
const Orders = () => {
  const [selectedCity, setSelectedCity] = useState("All Orders");
  ...
  const cities = ["All Orders", "Hyderabad", "Vijayawada", "Bangalore"];

  const filteredOrders =
    selectedCity === "All Orders"
      ? orders
  ...
  return (
    <div className="px-6 py-4">
      <div className="flex justify-between items-center mb-6">
        ...
        <h1 className="text-4xl font-semibold font-[Parastoo] text-gray-800">
          Orders Overview
        </h1>
